    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseholdGroupUser", x => new { x.HouseholdsId, x.MembersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HouseholdGroupId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseholdGroupUser_MembersId",
                table: "HouseholdGroupUser",
                column: "MembersId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseholdTask_ExecutorId",
                table: "HouseholdTask",
                column: "ExecutorId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseholdTask_HouseholdGroupId",
                table: "HouseholdTask",
